...
export function Review({room,action,busy}){
  ...
  const {locale}=useI18n();
  const [sent,setSent]=useState(false);
  const pack=useRemote('day-pack',[room.day]),criteria=pack.data?.reviewCriteria||null;
