...
function TaskQueue({room,action,busy}){
  const t=useT();
  const {locale}=useI18n();
  const data=useFetched('tasks/queue',[room.day,trailKey(room)]);
  if(!data)return null;
