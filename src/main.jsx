...
const loginErrorCopy={domain:'Dit Google-account hoort niet bij een toegestaan werkdomein. Gebruik je AetherLink- of schoolaccount, of vraag de beheerder.',disabled:'Google-login is nu niet beschikbaar. Gebruik de startsleutel of vraag de beheerder.',token:'Google kon je account niet bevestigen. Probeer opnieuw in te loggen.',verify:'Google kon je account niet bevestigen. Probeer opnieuw in te loggen.',session:'Je Google-login is gelukt, maar de facilitator-sessie kon niet worden opgeslagen. Probeer opnieuw of gebruik de startsleutel.',state:'Je Google-login is onderbroken. Start opnieuw met de Google-knop.',expired:'Je Google-login is verlopen. Start opnieuw met de Google-knop.',mismatch:'Je Google-login klopte niet meer. Start opnieuw met de Google-knop.','no-cookie':'Je Google-login is onderbroken (geen sessiecookie). Start opnieuw.','no-server-state':'Je Google-login is verlopen op de server. Start opnieuw.','bad-signature':'Je Google-login was ongeldig. Start opnieuw.'};
