...
`apps/server/src/importers/` (`slides-js`, `curriculum-md`, `day-decks-json`, `content-mjs`; Markdown round-trip included). Follow the frontmatter below. Do not invent
...
Day packs: `pnpm lint:content:support-1` · `pnpm lint:content:support-2` · `pnpm lint:content:support-3`.

## Days

- `courses/worldline-wave-2/support-1/` — day 1 n8n (AET-36)
- `courses/worldline-wave-2/support-2/` — day 2 Eve + Claude Agent SDK (AET-37)
