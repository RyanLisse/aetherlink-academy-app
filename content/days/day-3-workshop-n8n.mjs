...
export default {
 ...
 mission:{
  ...
  allowed:['Gebruik alleen de workshop-n8n-instantie en de fictieve fixture-tickets.','Configureer je eigen credential in n8n; nooit een key in de workflow of op het scherm.','Dien bewijs in; een mens beslist over acceptatie.'],
