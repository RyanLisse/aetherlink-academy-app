#!/usr/bin/env node
/**
 * Interim AC lint for content/courses/worldline-wave-2/teaching-1/
...
const dayDir = path.join(root, "content/courses/worldline-wave-2/teaching-1");
...
console.log(`PASS: ${files.length} lessons OK under teaching-1`);
