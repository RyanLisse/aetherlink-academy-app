...
function DeckContent({slides, index, revealStep, mode, onIndexChange, onRevealStepChange, presence}: DeckProps) {
  ...
  return <div className={`academy-deck mode-${mode} deck-type-${type}${activeSlide.dark ? " spotlight" : ""}`} data-type={type} data-opener={typeof visual(activeSlide).opener === 'string' ? visual(activeSlide).opener : ''} data-index={index} data-total={total}>
