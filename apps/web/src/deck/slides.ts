/** Synced from jyse/aetherlink-classroom-slides @ cons/cursus-aanpassingen tip abde6d1b.
 *  Do not hand-edit curriculum prose — re-sync from SoT. Day 1 ends before the "TEACHING DAY 2" divider (see normalize.ts).
 */
/* ==========================================================================
