...
// Every attempt records on its own day (retakes: latest wins). Only an attempt on the room's
// live day steers the live help route and quiz badge; practising an earlier day leaves them alone.
