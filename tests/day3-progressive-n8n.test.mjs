...
test('day 3 pack exposes progressive n8n steps 0→1→multi',()=>{
 ...
 assert.deepEqual(pack.quiz.key,{'d3-q1':'b','d3-q2':'b','d3-q3':'b'});
...
test('day 3 quiz scores progressive answers after facilitator sets day',async()=>{
 ...
 const perfect=await answerQuiz(app,participant.token,{'d3-q1':'b','d3-q2':'b','d3-q3':'b'});
 ...
 const guided=await answerQuiz(app,participant.token,{'d3-q1':'a','d3-q2':'a','d3-q3':'a'});
